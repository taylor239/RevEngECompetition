...
<table id="inner_content">
	<tr>
        ...
        <td width="67%">
        <input form="updateForm" form="updateForm" style="width:90%" type="text" name="challenge_name" value="Challenge Name"></input>
        </td>
        </tr>
        <tr>
        <td width="33%">
        ...
        <td width="67%">
        <textarea form="updateForm" style="width:90%" name="description">Description</textarea>
        </td>
        </tr>
        <%
        for(int x=0; x<1; x++)
        {
	        ...
	        <td width="67%">
	        <input form="updateForm" style="width:90%" type="text" name="command_order_<%=x %>" value="Execution Order (integer)"></input>
	        </td>
        	</tr>
        	<tr>
        	<td width="33%">
	        ...
	        <td width="67%">
	        <input form="updateForm" style="width:90%" type="text" name="commandName_<%=x %>" value="Command"></input>
	        </td>
        	</tr>
        	<tr>
        	<td width="33%">
	        ...
	        <td width="67%">
	        <textarea form="updateForm" style="width:90%" name="command_<%=x %>">Arguments</textarea>
	        </td>
        	</tr>
        	</table>
        	</td>
        ...
        <tr>
        <td width="50%">
        <input form="updateForm" type="hidden" name="totalAdd" id="totalAdd" value="0"></input>
