...
static void jit_internal_emit_sse_fst_op(struct jit * jit, jit_op * op, jit_value a1, jit_value a2)
{
 if (op->arg_size == sizeof(float)) {
  ...
  if ((op->code & 0x02)) do { *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | ((((a1)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((0) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x13; do { *((jit->ip))++ = ((((0)&0x03)<<6)|((((a1))&0x07)<<3)|(((4)&0x07))); } while (0); do { *((jit->ip))++ = ((((0)&0x03)<<6)|(((4)&0x07)<<3)|(((5)&0x07))); } while (0); do { jit_internal_x86_imm_buf imb; imb.val = (int) ((a2)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
...
{
 if (JIT_REG(r).spec == (0)) {
  if (JIT_REG(r). type == (0)) return (- ((JIT_REG(r).id + 1) * (sizeof(void *))) - jit_current_func_info(jit)->allocai_mem);
  else return (- jit_current_func_info(jit)->gp_reg_count * (sizeof(void *)) - (JIT_REG(r).id + 1) * sizeof(jit_float) - jit_current_func_info(jit)->allocai_mem);
 } else return ((- (JIT_REG(r).id + jit_current_func_info(jit)->gp_reg_count + jit_current_func_info(jit)->fp_reg_count) * (sizeof(void *))) - jit_current_func_info(jit)->allocai_mem);
}
void jit_optimize_st_ops(struct jit * jit)
{
...
static inline void jit_internal_emit_fppush_arg(struct jit * jit, struct jit_out_arg * arg)
{
 ...
 if (arg->size == sizeof(double)) {
  if (arg->isreg) {
   if (jit_internal_is_spilled(arg->value.generic, jit->prepared_args.op, &sreg)) {
    int pos = (- jit_current_func_info(jit)->gp_reg_count * (sizeof(void *)) - (JIT_REG(arg->value.generic).id + 1) * sizeof(jit_float) - jit_current_func_info(jit)->allocai_mem);
...
{
 jit_value arg = op->r_arg[0];
 if (op->arg_size == sizeof(float)) do { *(((jit->ip)))++ = (unsigned char)((0xf3)); do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | ((((((arg)))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((((AMD64_XMM0)))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *((((jit->ip))))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(((jit->ip)))++ = (unsigned char)((0x0f)); *(((jit->ip)))++ = (unsigned char)((0x5a)); do { do { *(((((jit->ip)))))++ = ((((3)&0x03)<<6)|(((((((arg)))))&0x07)<<3)|(((((((AMD64_XMM0)))))&0x07))); } while (0); } while (0); } while (0);
 else if (arg != AMD64_XMM0) do { *(((jit->ip)))++ = (unsigned char)((0xf2)); do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | ((((((arg)))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((((AMD64_XMM0)))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *((((jit->ip))))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(((jit->ip)))++ = (unsigned char)((0x0f)); *(((jit->ip)))++ = (unsigned char)((0x10)); do { do { *(((((jit->ip)))))++ = ((((3)&0x03)<<6)|(((((((arg)))))&0x07)<<3)|(((((((AMD64_XMM0)))))&0x07))); } while (0); } while (0); } while (0);
}
void jit_patch_external_calls(struct jit * jit)
{
}
...
static void jit_internal_emit_push_reg(struct jit * jit, jit_hw_reg * r)
{
 if (!r->fp) do { do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | (((0) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((r->id)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(jit->ip)++ = (unsigned char)0x50 + ((r->id) & 0x7); } while (0);
 else {
  do { if ((((int)(((8))) >= -128 && (int)(((8))) <= 127))) { do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | (((0) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((((AMD64_RSP))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *((jit->ip))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *((jit->ip))++ = (unsigned char)0x83; do { do { *((((jit->ip))))++ = ((((3)&0x03)<<6)|((((((X86_SUB))))&0x07)<<3)|((((((AMD64_RSP))))&0x07))); } while (0); } while (0); do { *(((jit->ip))) = (unsigned char)((((8))) & 0xff); ++(((jit->ip))); } while (0); } else if (((AMD64_RSP)) == AMD64_RAX) { do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | (((0) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((0) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *((jit->ip))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *((jit->ip))++ = (((unsigned char)((X86_SUB))) << 3) + 5; do { jit_internal_x86_imm_buf imb; imb.val = (int) (((8))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } else { do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | (((0) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((((AMD64_RSP))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *((jit->ip))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *((jit->ip))++ = (unsigned char)0x81; do { do { *((((jit->ip))))++ = ((((3)&0x03)<<6)|((((((X86_SUB))))&0x07)<<3)|((((((AMD64_RSP))))&0x07))); } while (0); } while (0); do { jit_internal_x86_imm_buf imb; imb.val = (int) (((8))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0);
  do { *((jit->ip))++ = (unsigned char)(0x66); do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | (((((r->id))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((((AMD64_RSP)) == AMD64_RIP ? 0 : ((AMD64_RSP))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *(((jit->ip)))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *((jit->ip))++ = (unsigned char)(0x0f); *((jit->ip))++ = (unsigned char)(0x13); do { if ((((AMD64_RSP))) == AMD64_RIP) { do { *((((jit->ip))))++ = ((((0)&0x03)<<6)|((((((r->id)))&0x7)&0x07)<<3)|(((5)&0x07))); } while (0); do { jit_internal_x86_imm_buf imb; imb.val = (int) ((((0)))); *((((jit->ip))))++ = imb.b [0]; *((((jit->ip))))++ = imb.b [1]; *((((jit->ip))))++ = imb.b [2]; *((((jit->ip))))++ = imb.b [3]; } while (0); } else do { if (((((AMD64_RSP)))&0x7) == X86_ESP) { if (((((0)))) == 0) { do { *(((((jit->ip)))))++ = ((((0)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((((jit->ip)))))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((((0))))) >= -128 && (int)(((((0))))) <= 127))) { do { *(((((jit->ip)))))++ = ((((1)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((((jit->ip)))))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((((jit->ip))))) = (unsigned char)((((((0))))) & 0xff); ++(((((jit->ip))))); } while (0); } else { do { *(((((jit->ip)))))++ = ((((2)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((((jit->ip)))))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { jit_internal_x86_imm_buf imb; imb.val = (int) (((((0))))); *(((((jit->ip)))))++ = imb.b [0]; *(((((jit->ip)))))++ = imb.b [1]; *(((((jit->ip)))))++ = imb.b [2]; *(((((jit->ip)))))++ = imb.b [3]; } while (0); } break; } if (((((0)))) == 0 && ((((AMD64_RSP)))&0x7) != X86_EBP) { do { *(((((jit->ip)))))++ = ((((0)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((((((AMD64_RSP)))&0x7))&0x07))); } while (0); break; } if ((((int)(((((0))))) >= -128 && (int)(((((0))))) <= 127))) { do { *(((((jit->ip)))))++ = ((((1)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((((((AMD64_RSP)))&0x7))&0x07))); } while (0); do { *(((((jit->ip))))) = (unsigned char)((((((0))))) & 0xff); ++(((((jit->ip))))); } while (0); } else { do { *(((((jit->ip)))))++ = ((((2)&0x03)<<6)|(((((((r->id)))&0x7))&0x07)<<3)|(((((((AMD64_RSP)))&0x7))&0x07))); } while (0); do { jit_internal_x86_imm_buf imb; imb.val = (int) (((((0))))); *(((((jit->ip)))))++ = imb.b [0]; *(((((jit->ip)))))++ = imb.b [1]; *(((((jit->ip)))))++ = imb.b [2]; *(((((jit->ip)))))++ = imb.b [3]; } while (0); } } while (0); } while (0); } while (0);
 }
}
static void jit_internal_emit_pop_reg(struct jit * jit, jit_hw_reg * r)
{
 if (!r->fp) do { do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | (((0) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((r->id)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(jit->ip)++ = (unsigned char)0x58 + ((r->id) & 0x7); } while (0);
 else {
...
static int jit_internal_uses_hw_reg(struct jit_op * op, jit_value reg, int fp)
{
 ...
 for (int i = 0; i < 3; i++)
  if (((((op)->spec >> ((i + 1) - 1) * 2) & 0x03) == 0x01) || ((((op)->spec >> ((i + 1) - 1) * 2) & 0x03) == 0x03)) {
   if (fp && (JIT_REG(op->arg[i]).type == (0))) continue;
   if (!fp && (JIT_REG(op->arg[i]).type == (1))) continue;
  ...
  if (r->callee_saved)
   for (struct jit_op * o = op->next; o != NULL; o = o->next) {
    ...
    if (jit_internal_uses_hw_reg(o, r->id, 0)) {
     jit_internal_emit_push_reg(jit, r);
     count++;
     break;
    }
   }
 ...
 for (int i = jit->reg_al->gp_reg_cnt - 1; i >= 0; i--) {
  ...
  if (r->callee_saved)
   for (struct jit_op * o = op->next; o != NULL; o = o->next) {
    if (((jit_opcode) (o->code & 0xfff8)) == JIT_PROLOG) break;
    if (jit_internal_uses_hw_reg(o, r->id, 0)) {
     jit_internal_emit_pop_reg(jit, r);
     count++;
     break;
    }
   }
  ...
  jit_hw_reg * regs, int fp, jit_hw_reg * skip_reg)
{
 ...
 for (int i = 0; i < reg_count; i++) {
  ...
  if (hreg && jit_set_get(op->live_in, reg)) jit_internal_emit_push_reg(jit, hreg), count++;
 }
 return count;
}
static int jit_internal_emit_push_caller_saved_regs(struct jit * jit, jit_op * op)
{
 ...
 count += jit_internal_generic_push_caller_saved_regs(jit, op, al->gp_reg_cnt, al->gp_regs, 0, al->ret_reg);
 count += jit_internal_generic_push_caller_saved_regs(jit, op, al->fp_reg_cnt, al->fp_regs, 1, al->fpret_reg);
 return count;
}
          ...
          jit_hw_reg * regs, int fp, jit_hw_reg * skip_reg)
{
 ...
 for (int i = reg_count - 1; i >= 0; i--) {
  if ((regs[i].id == skip_reg_id) || (regs[i].callee_saved)) continue;
  jit_hw_reg * hreg = jit_internal_rmap_is_associated(op->regmap, regs[i].id, fp, &reg);
  if (hreg && jit_set_get(op->live_in, reg)) jit_internal_emit_pop_reg(jit, hreg), count++;
 }
 return count;
}
static int jit_internal_emit_pop_caller_saved_regs(struct jit * jit, jit_op * op)
{
 int count = 0;
 struct jit_reg_allocator * al = jit->reg_al;
 count += jit_internal_generic_pop_caller_saved_regs(jit, op, al->fp_reg_cnt, al->fp_regs, 1, al->fpret_reg);
 count += jit_internal_generic_pop_caller_saved_regs(jit, op, al->gp_reg_cnt, al->gp_regs, 0, al->ret_reg);
 return count;
}
...
static void jit_internal_emit_get_arg(struct jit * jit, jit_op * op)
{
 ...
 int size = arg->size;
 int type = arg->type;
 int reg_id = jit_mkreg(type == JIT_FLOAT_NUM ? (1) : (0), (3), arg_id);
 ...
 if (type != JIT_FLOAT_NUM) {
  if (size == (sizeof(void *))) do { if (((sizeof(void *))) == 2) *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = (((((sizeof(void *)))) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((((sizeof(void *)))) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); switch (((sizeof(void *)))) { case 1: *(jit->ip)++ = (unsigned char)0x8a; break; case 2: case 4: case 8: *(jit->ip)++ = (unsigned char)0x8b; break; default: assert (0); } do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)))&0x07)<<3)|(((((reg)))&0x07))); } while (0); } while (0); } while (0);
  else if (type == JIT_SIGNED_NUM) do { if ((size) == 4) { do { do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(jit->ip)++ = (unsigned char)0x63; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)&0x7))&0x07)<<3)|(((((reg)&0x7))&0x07))); } while (0); } while (0); } while (0); break; } if ((size) == 2) *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); switch ((size)) { case 1: *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0xbe; break; case 2: *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0xbf; break; default: assert (0); } do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)))&0x07)<<3)|(((((reg)))&0x07))); } while (0); } while (0); } while (0);
  else do { if ((size) == 8) { do { if ((8) == 2) *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = ((((8)) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || ((((8)) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); switch ((8)) { case 1: *(jit->ip)++ = (unsigned char)0x8a; break; case 2: case 4: case 8: *(jit->ip)++ = (unsigned char)0x8b; break; default: assert (0); } do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)))&0x07)<<3)|(((((reg)))&0x07))); } while (0); } while (0); } while (0); break; } if ((size) == 4) { do { do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | (((((dreg))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | (((((dreg))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *((jit->ip))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *((jit->ip))++ = (((unsigned char)((X86_XOR))) << 3) + 3; do { do { *((((jit->ip))))++ = ((((3)&0x03)<<6)|((((((dreg))))&0x07)<<3)|((((((dreg))))&0x07))); } while (0); } while (0); } while (0); do { if ((4) == 2) *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = ((((4)) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || ((((4)) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); switch ((4)) { case 1: *(jit->ip)++ = (unsigned char)0x8a; break; case 2: case 4: case 8: *(jit->ip)++ = (unsigned char)0x8b; break; default: assert (0); } do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)))&0x07)<<3)|(((((reg)))&0x07))); } while (0); } while (0); } while (0); break; } if ((size) == 2) *(jit->ip)++ = (unsigned char)0x66; do { unsigned char _amd64_rex_bits = (((8) > 4) ? AMD64_REX_W : 0) | ((((dreg)) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((reg)) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((8) == 1))) *(jit->ip)++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); switch ((size)) { case 1: *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0xb6; break; case 2: *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0xb7; break; default: assert (0); } do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((dreg)))&0x07)<<3)|(((((reg)))&0x07))); } while (0); } while (0); } while (0);
 } else {
  if (size == sizeof(float)) do { *(((jit->ip)))++ = (unsigned char)((0xf3)); do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | ((((((dreg)))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((((reg)))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *((((jit->ip))))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(((jit->ip)))++ = (unsigned char)((0x0f)); *(((jit->ip)))++ = (unsigned char)((0x5a)); do { do { *(((((jit->ip)))))++ = ((((3)&0x03)<<6)|(((((((dreg)))))&0x07)<<3)|(((((((reg)))))&0x07))); } while (0); } while (0); } while (0);
  else do { *(((jit->ip)))++ = (unsigned char)((0xf2)); do { unsigned char _amd64_rex_bits = (((0) > 4) ? AMD64_REX_W : 0) | ((((((dreg)))) > 7) ? AMD64_REX_R : 0) | (((0) > 7) ? AMD64_REX_X : 0) | ((((((reg)))) > 7) ? AMD64_REX_B : 0); if ((_amd64_rex_bits != 0) || (((0) == 1))) *((((jit->ip))))++ = ((unsigned char)(0x40 | (_amd64_rex_bits))); } while (0); *(((jit->ip)))++ = (unsigned char)((0x0f)); *(((jit->ip)))++ = (unsigned char)((0x10)); do { do { *(((((jit->ip)))))++ = ((((3)&0x03)<<6)|(((((((dreg)))))&0x07)<<3)|(((((((reg)))))&0x07))); } while (0); } while (0); } while (0);
 }
}
...
static inline void jit_internal_flw_analyze_prolog(struct jit * jit, jit_op * op, struct jit_func_info * func_info)
{
 for (int i = 0; i < func_info->general_arg_cnt + func_info->float_arg_cnt; i++) {
  if (func_info->args[i].type == JIT_FLOAT_NUM) {
   jit_set_remove(op->live_in, jit_mkreg((1), (3), i));
  } else {
   jit_set_remove(op->live_in, jit_mkreg((0), (3), i));
  }
 }
}
...
static void jit_internal_assign_regs_for_args(struct jit_reg_allocator * al, jit_op * op)
{
 ...
 for (int i = 0; i < info->general_arg_cnt + info->float_arg_cnt; i++) {
  ...
  if (isfp_arg && (assoc_fp_regs < al->fp_arg_reg_cnt)) {
   jit_internal_rmap_assoc(op->regmap, jit_mkreg((1), (3), i), al->fp_arg_regs[assoc_fp_regs]);
   assoc_fp_regs++;
  }
 }
}
