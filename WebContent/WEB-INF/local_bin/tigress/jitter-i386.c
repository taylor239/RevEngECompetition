...
{
 do { *(jit->ip)++ = (unsigned char)0x66; *(jit->ip)++ = (unsigned char)0x0F; *(jit->ip)++ = (unsigned char)(X86_SSE_XOR); do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((reg)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) ((((double *)emit_sse_get_sign_mask()))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
}
...
static void emit_sse_round(struct jit * jit, jit_op * op, jit_value a1, jit_value a2)
{
 ...
 do { *(jit->ip)++ = (unsigned char)0x66; *(jit->ip)++ = (unsigned char)0x0F; *(jit->ip)++ = (unsigned char)(X86_SSE_COMI); do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a2)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) ((((double *)&x0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);

 unsigned char * branch1 = jit->ip;
 do { int offset = (0) - 2; if ((((int)((offset)) >= -128 && (int)((offset)) <= 127))) do { if (((0))) *((jit->ip))++ = x86_cc_signed_map [((X86_CC_LT))]; else *((jit->ip))++ = x86_cc_unsigned_map [((X86_CC_LT))]; do { *(((jit->ip))) = (unsigned char)(((offset)) & 0xff); ++(((jit->ip))); } while (0); } while (0); else { offset -= 4; do { *((jit->ip))++ = (unsigned char)0x0f; if (((0))) *((jit->ip))++ = x86_cc_signed_map [((X86_CC_LT))] + 0x10; else *((jit->ip))++ = x86_cc_unsigned_map [((X86_CC_LT))] + 0x10; do { x86_imm_buf imb; imb.val = (int) ((offset)); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } } while (0);

 do { *(jit->ip)++ = (unsigned char)0xF2; *(jit->ip)++ = (unsigned char)0x0F; *(jit->ip)++ = (unsigned char)(X86_SSE_ADD); do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a2)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) ((((double *)&x05))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);

 unsigned char * branch2 = jit->ip;
 do { int t = (0) - 2; if ((((int)(t) >= -128 && (int)(t) <= 127))) { do { *((jit->ip))++ = (unsigned char)0xeb; do { *(((jit->ip))) = (unsigned char)(((t)) & 0xff); ++(((jit->ip))); } while (0); } while (0); } else { t -= 3; do { *((jit->ip))++ = (unsigned char)0xe9; do { x86_imm_buf imb; imb.val = (int) ((t)); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } } while (0);
 ...
 do { *(jit->ip)++ = (unsigned char)0xF2; *(jit->ip)++ = (unsigned char)0x0F; *(jit->ip)++ = (unsigned char)(X86_SSE_SUB); do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a2)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) ((((double *)&x05))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
...
static void emit_sse_fst_op(struct jit * jit, jit_op * op, jit_value a1, jit_value a2)
{
 if (op->arg_size == sizeof(float)) {
  ...
  if ((op->code & 0x02)) do { *(jit->ip)++ = (unsigned char)0x66; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x13; do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((a2))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
...
{
 if (op->arg_size == sizeof(float)) {
  if ((op->code & 0x02)) do { *(jit->ip)++ = (unsigned char)0xf3; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x5a; do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((a2))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
  else do { *(jit->ip)++ = (unsigned char)0xf3; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x5a; do { if (((a2)) == X86_ESP) { if (((0)) == 0) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } break; } if (((0)) == 0 && ((a2)) != X86_EBP) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((((a2)))&0x07))); } while (0); break; } if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((((a2)))&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((((a2)))&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0); } while (0);
 } else {
  if ((op->code & 0x02)) do { *(jit->ip)++ = (unsigned char)0xf2; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x10; do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((a2))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
...
static int emit_arguments(struct jit * jit)
{
 ...
 for (int i = jit->prepared_args.ready - 1; i >= 0; i--) {
  ...
  if (!args[i].isfp) {
   if (!args[i].isreg) do { int _imm = (int) (args[i].value.generic); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
   else {
    if (is_spilled(value, jit->prepared_args.op, &sreg))
     do { *(jit->ip)++ = (unsigned char)0xff; do { if (((X86_EBP)) == X86_ESP) { if (((GET_REG_POS(jit, args[i].value.generic))) == 0) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|((((6))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((GET_REG_POS(jit, args[i].value.generic)))) >= -128 && (int)(((GET_REG_POS(jit, args[i].value.generic)))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|((((6))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((GET_REG_POS(jit, args[i].value.generic)))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|((((6))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((GET_REG_POS(jit, args[i].value.generic)))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } break; } if (((GET_REG_POS(jit, args[i].value.generic))) == 0 && ((X86_EBP)) != X86_EBP) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|((((6))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); break; } if ((((int)(((GET_REG_POS(jit, args[i].value.generic)))) >= -128 && (int)(((GET_REG_POS(jit, args[i].value.generic)))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|((((6))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((GET_REG_POS(jit, args[i].value.generic)))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|((((6))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((GET_REG_POS(jit, args[i].value.generic)))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0); } while (0);
  ...
  if (args[i].isreg) {
   ...
   do { int _imm = (int) (fl_val); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
  }
 }
...
void jit_patch_external_calls(struct jit * jit)
{
 for (jit_op * op = jit_op_first(jit->ops); op != NULL; op = op->next) {
  if ((op->code == (JIT_CALL | 0x02)) && (!jit_is_label(jit, (void *)op->arg[0])))
   do { unsigned char* pos = (jit->buf + (long)op->patch_addr) + 1; int disp, size = 0; switch (*(unsigned char*)(jit->buf + (long)op->patch_addr)) { case 0xe8: case 0xe9: ++size; break; case 0x0f: if (!(*pos >= 0x70 && *pos <= 0x8f)) assert (0); ++size; ++pos; break; case 0xe0: case 0xe1: case 0xe2: case 0xeb: case 0x70: case 0x71: case 0x72: case 0x73: case 0x74: case 0x75: case 0x76: case 0x77: case 0x78: case 0x79: case 0x7a: case 0x7b: case 0x7c: case 0x7d: case 0x7e: case 0x7f: break; default: assert (0); } disp = ((unsigned char *)op->arg[0]) - pos; if (size) do { x86_imm_buf imb; imb.val = (int) (disp - 4); *(pos)++ = imb.b [0]; *(pos)++ = imb.b [1]; *(pos)++ = imb.b [2]; *(pos)++ = imb.b [3]; } while (0); else if ((((int)(disp - 1) >= -128 && (int)(disp - 1) <= 127))) do { *(pos) = (unsigned char)((disp - 1) & 0xff); ++(pos); } while (0); else assert (0); } while (0);
  if (((jit_opcode) (op->code & 0xfff8)) == JIT_MSG)
   do { unsigned char* pos = (jit->buf + (long)op->patch_addr) + 1; int disp, size = 0; switch (*(unsigned char*)(jit->buf + (long)op->patch_addr)) { case 0xe8: case 0xe9: ++size; break; case 0x0f: if (!(*pos >= 0x70 && *pos <= 0x8f)) assert (0); ++size; ++pos; break; case 0xe0: case 0xe1: case 0xe2: case 0xeb: case 0x70: case 0x71: case 0x72: case 0x73: case 0x74: case 0x75: case 0x76: case 0x77: case 0x78: case 0x79: case 0x7a: case 0x7b: case 0x7c: case 0x7d: case 0x7e: case 0x7f: break; default: assert (0); } disp = ((unsigned char *)printf) - pos; if (size) do { x86_imm_buf imb; imb.val = (int) (disp - 4); *(pos)++ = imb.b [0]; *(pos)++ = imb.b [1]; *(pos)++ = imb.b [2]; *(pos)++ = imb.b [3]; } while (0); else if ((((int)(disp - 1) >= -128 && (int)(disp - 1) <= 127))) do { *(pos) = (unsigned char)((disp - 1) & 0xff); ++(pos); } while (0); else assert (0); } while (0);
  if (((jit_opcode) (op->code & 0xfff8)) == JIT_TRACE)
   do { unsigned char* pos = (jit->buf + (long)op->patch_addr) + 1; int disp, size = 0; switch (*(unsigned char*)(jit->buf + (long)op->patch_addr)) { case 0xe8: case 0xe9: ++size; break; case 0x0f: if (!(*pos >= 0x70 && *pos <= 0x8f)) assert (0); ++size; ++pos; break; case 0xe0: case 0xe1: case 0xe2: case 0xeb: case 0x70: case 0x71: case 0x72: case 0x73: case 0x74: case 0x75: case 0x76: case 0x77: case 0x78: case 0x79: case 0x7a: case 0x7b: case 0x7c: case 0x7d: case 0x7e: case 0x7f: break; default: assert (0); } disp = ((unsigned char *)jit_trace_callback) - pos; if (size) do { x86_imm_buf imb; imb.val = (int) (disp - 4); *(pos)++ = imb.b [0]; *(pos)++ = imb.b [1]; *(pos)++ = imb.b [2]; *(pos)++ = imb.b [3]; } while (0); else if ((((int)(disp - 1) >= -128 && (int)(disp - 1) <= 127))) do { *(pos) = (unsigned char)((disp - 1) & 0xff); ++(pos); } while (0); else assert (0); } while (0);
 }
}
...
static void emit_prolog_op(struct jit * jit, jit_op * op)
{
 ...
 if (prolog)
  do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_SUB)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((stack_mem)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((stack_mem)) >= -128 && (int)((stack_mem)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((stack_mem)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((stack_mem)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
...
static void emit_msg_op(struct jit * jit, jit_op * op)
{
 ...
 do { int _imm = (int) (op->r_arg[0]); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 op->patch_addr = ((jit_value)jit->ip - (jit_value)jit->buf);
 do { *(jit->ip)++ = (unsigned char)0xe8; do { x86_imm_buf imb; imb.val = (int) ((int)(printf)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
 if ((op->code & 0x02)) do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((4)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((4)) >= -128 && (int)((4)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((4)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((4)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 else do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((8)) >= -128 && (int)((8)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((8)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
...
static void emit_trace_op(struct jit *jit, jit_op *op)
{
 ...
 do { int _imm = (int) (trace); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 do { int _imm = (int) (op->r_arg[0]); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 do { int _imm = (int) (op); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 do { int _imm = (int) (jit); if ((((int)(_imm) >= -128 && (int)(_imm) <= 127))) { *(jit->ip)++ = (unsigned char)0x6A; do { *((jit->ip)) = (unsigned char)(((_imm)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x68; do { x86_imm_buf imb; imb.val = (int) ((_imm)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);

 op->patch_addr = ((jit_value)jit->ip - (jit_value)jit->buf);
 do { *(jit->ip)++ = (unsigned char)0xe8; do { x86_imm_buf imb; imb.val = (int) ((int)(jit_trace_callback)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
 do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((16)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((16)) >= -128 && (int)((16)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((16)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((16)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
...
static int emit_push_callee_saved_regs(struct jit * jit, jit_op * op)
{
 ...
 if (stack_offset) do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_SUB)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((stack_offset)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((stack_offset)) >= -128 && (int)((stack_offset)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((stack_offset)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((stack_offset)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
...
static int emit_pop_callee_saved_regs(struct jit * jit)
{
 ...
 if (stack_space) do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((stack_space)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((stack_space)) >= -128 && (int)((stack_space)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((stack_space)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((stack_space)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 return count;
}
...
static void emit_save_all_regs(struct jit *jit, jit_op *op)
{
 ...
 for (int i = 0; i < al->fp_reg_cnt; i++) {
  jit_hw_reg *reg = &al->fp_regs[i];
  if (!reg->callee_saved && is_active_register(al, reg, op))
   { do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_SUB)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((8)) >= -128 && (int)((8)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((8)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0); do { *(jit->ip)++ = (unsigned char)0x66; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x13; do { if (((X86_ESP)) == X86_ESP) { if (((0)) == 0) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } break; } if (((0)) == 0 && ((X86_ESP)) != X86_EBP) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); break; } if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0); } while (0); } while(0);
 }

 int alignment = required_stack_space_for_regs(jit, op) % 16;
 if (alignment != 0) do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_SUB)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((16 - alignment)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((16 - alignment)) >= -128 && (int)((16 - alignment)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((16 - alignment)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_SUB)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((16 - alignment)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
}

static void emit_restore_all_regs(struct jit *jit, jit_op *op)
{
 int alignment = required_stack_space_for_regs(jit, op) % 16;
 if (alignment != 0) do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((16 - alignment)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((16 - alignment)) >= -128 && (int)((16 - alignment)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((16 - alignment)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((16 - alignment)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);
 ...
 for (int i = al->fp_reg_cnt - 1; i >= 0; i--) {
  jit_hw_reg *reg = &al->fp_regs[i];
  if (!reg->callee_saved && is_active_register(al, reg, op))
   { do { *(jit->ip)++ = (unsigned char)0x66; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x12; do { if (((X86_ESP)) == X86_ESP) { if (((0)) == 0) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } break; } if (((0)) == 0 && ((X86_ESP)) != X86_EBP) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); break; } if ((((int)(((0))) >= -128 && (int)(((0))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((0))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((reg->id)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((0))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0); } while (0); do { if ((X86_ESP) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_ADD)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((8)) >= -128 && (int)((8)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((8)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_ADD)))&0x07)<<3)|(((((X86_ESP)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((8)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0);} while(0);
 }
...
static void emit_get_arg(struct jit * jit, jit_op * op)
{
 ...
 if (!arg->passed_by_reg) {
  ...
  if (!jit_current_func_info(jit)->has_prolog) {
   ...
   emit_get_arg_from_stack(jit, type, size, dreg, X86_ESP, stack_pos);
   return;
  }
 }
 ...
 if (read_from_stack) {
  emit_get_arg_from_stack(jit, type, size, dreg, X86_EBP, stack_pos);
  return;
 }
...
static void emit_mul_op(struct jit * jit, struct jit_op * op, int imm, int sign, int high_bytes)
{
 ...
 if (imm) {
  ...
  do { *(jit->ip)++ = (unsigned char)0xb8 + (X86_EDX); do { x86_imm_buf imb; imb.val = (int) ((factor2)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
...
static void emit_div_op(struct jit * jit, struct jit_op * op, int imm, int sign, int modulo)
{
 ...
 if (imm && ((divisor == 2) || (divisor == 4) || (divisor == 8))) {
  ...
  if (modulo && !sign) {
   switch (divisor) {
    case 2: do { if ((dest) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_AND)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((0x1)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((0x1)) >= -128 && (int)((0x1)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((0x1)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((0x1)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0); break;
    case 4: do { if ((dest) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_AND)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((0x3)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((0x3)) >= -128 && (int)((0x3)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((0x3)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((0x3)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0); break;
    case 8: do { if ((dest) == X86_EAX) { *(jit->ip)++ = (((unsigned char)(X86_AND)) << 3) + 5; do { x86_imm_buf imb; imb.val = (int) ((0x7)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); break; } if ((((int)((0x7)) >= -128 && (int)((0x7)) <= 127))) { *(jit->ip)++ = (unsigned char)0x83; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { *((jit->ip)) = (unsigned char)(((0x7)) & 0xff); ++((jit->ip)); } while (0); } else { *(jit->ip)++ = (unsigned char)0x81; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((X86_AND)))&0x07)<<3)|(((((dest)))&0x07))); } while (0); } while (0); do { x86_imm_buf imb; imb.val = (int) ((0x7)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } } while (0); break;
   }
   return;
  }
 }
 ...
 if (imm) {
  ...
  do { *(jit->ip)++ = (unsigned char)0xb8 + (X86_EBX); do { x86_imm_buf imb; imb.val = (int) ((divisor)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
...
static void emit_cond_op(struct jit * jit, struct jit_op * op, int amd64_cond, int imm, int sign)
{
 ...
 if ((op->r_arg[0] != X86_ESI) && (op->r_arg[0] != X86_EDI)) {
  do { *(jit->ip)++ = (unsigned char)0xb8 + (op->r_arg[0]); do { x86_imm_buf imb; imb.val = (int) ((0)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
  do { assert(((op->r_arg[0]) < 4)); *(jit->ip)++ = (unsigned char)0x0f; if ((sign)) *(jit->ip)++ = x86_cc_signed_map [(amd64_cond)] + 0x20; else *(jit->ip)++ = x86_cc_unsigned_map [(amd64_cond)] + 0x20; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|((((0))&0x07)<<3)|(((((op->r_arg[0])))&0x07))); } while (0); } while (0); } while (0);
 } else {
  ...
  do { *(jit->ip)++ = (unsigned char)0xb8 + (X86_EAX); do { x86_imm_buf imb; imb.val = (int) ((0)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
  do { assert(((X86_EAX) < 4)); *(jit->ip)++ = (unsigned char)0x0f; if ((sign)) *(jit->ip)++ = x86_cc_signed_map [(amd64_cond)] + 0x20; else *(jit->ip)++ = x86_cc_unsigned_map [(amd64_cond)] + 0x20; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|((((0))&0x07)<<3)|(((((X86_EAX)))&0x07))); } while (0); } while (0); } while (0);
  do { if (((sizeof(void *))) == 1) *(jit->ip)++ = (unsigned char)0x86; else *(jit->ip)++ = (unsigned char)0x87; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|(((((op->r_arg[0])))&0x07)<<3)|(((((X86_EAX)))&0x07))); } while (0); } while (0); } while (0);
 }
}
...
{
 if (imm) do { if ((op->r_arg[1]) == X86_EAX) { *(jit->ip)++ = (unsigned char)0xa9; } else { *(jit->ip)++ = (unsigned char)0xf7; do { do { *(((jit->ip)))++ = ((((3)&0x03)<<6)|((((0))&0x07)<<3)|(((((op->r_arg[1])))&0x07))); } while (0); } while (0); } do { x86_imm_buf imb; imb.val = (int) ((op->r_arg[2])); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
...
static void emit_transfer_op(struct jit *jit, jit_op *op, int alu_op)
{
 ...
 else do { *(jit->ip)++ = (((unsigned char)(alu_op)) << 3) + 3; do { if (((X86_EBP)) == X86_ESP) { if (((GET_REG_POS(jit, op->arg[1]))) == 0) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); } else if ((((int)(((GET_REG_POS(jit, op->arg[1])))) >= -128 && (int)(((GET_REG_POS(jit, op->arg[1])))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((GET_REG_POS(jit, op->arg[1])))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((X86_ESP)&0x07)<<3)|(((X86_ESP)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((GET_REG_POS(jit, op->arg[1])))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } break; } if (((GET_REG_POS(jit, op->arg[1]))) == 0 && ((X86_EBP)) != X86_EBP) { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); break; } if ((((int)(((GET_REG_POS(jit, op->arg[1])))) >= -128 && (int)(((GET_REG_POS(jit, op->arg[1])))) <= 127))) { do { *(((jit->ip)))++ = ((((1)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); do { *(((jit->ip))) = (unsigned char)((((GET_REG_POS(jit, op->arg[1])))) & 0xff); ++(((jit->ip))); } while (0); } else { do { *(((jit->ip)))++ = ((((2)&0x03)<<6)|(((((tinf->scrapreg)))&0x07)<<3)|(((((X86_EBP)))&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((GET_REG_POS(jit, op->arg[1])))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } } while (0); } while (0);
...
void jit_patch_local_addrs(struct jit *jit)
{
 for (jit_op * op = jit_op_first(jit->ops); op != NULL; op = op->next) {
  if ((((jit_opcode) (op->code & 0xfff8)) == JIT_REF_CODE) || (((jit_opcode) (op->code & 0xfff8)) == JIT_REF_DATA)) {
   ...
   do { *(buf)++ = (unsigned char)0xb8 + (op->r_arg[0]); do { x86_imm_buf imb; imb.val = (int) ((jit->buf + addr)); *((buf))++ = imb.b [0]; *((buf))++ = imb.b [1]; *((buf))++ = imb.b [2]; *((buf))++ = imb.b [3]; } while (0); } while (0);
  }
...
void jit_gen_op(struct jit * jit, struct jit_op * op)
{
 ...
 switch (((jit_opcode) (op->code & 0xfff8))) {
  ...
  case JIT_JMP:
   ...
   else do { int t = ((!jit_is_label(jit, (void *)(a1)) ? (a1) : (((jit_value)jit->buf + ((jit_label *)(a1))->pos - (jit_value)jit->ip)))) - 5; do { *((jit->ip))++ = (unsigned char)0xe9; do { x86_imm_buf imb; imb.val = (int) ((t)); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0);
   break;
  case JIT_RET:
   ...
   if (imm) do { *(jit->ip)++ = (unsigned char)0xb8 + (X86_EAX); do { x86_imm_buf imb; imb.val = (int) ((a1)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
  ...
  case JIT_REF_DATA:
   op->patch_addr = ((jit_value)jit->ip - (jit_value)jit->buf);
   do { *(jit->ip)++ = (unsigned char)0xb8 + (a1); do { x86_imm_buf imb; imb.val = (int) ((0xdeadbeefcafebabe)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
   break;
 ...
 switch (op->code) {
  ...
  case (JIT_MOV | 0x02):
   ...
   else do { *(jit->ip)++ = (unsigned char)0xb8 + (a1); do { x86_imm_buf imb; imb.val = (int) ((a2)); *((jit->ip))++ = imb.b [0]; *((jit->ip))++ = imb.b [1]; *((jit->ip))++ = imb.b [2]; *((jit->ip))++ = imb.b [3]; } while (0); } while (0);
   break;
  ...
  case (JIT_FMOV | 0x02): do { *(jit->ip)++ = (unsigned char)0xf2; *(jit->ip)++ = (unsigned char)0x0f; *(jit->ip)++ = (unsigned char)0x10; do { do { *(((jit->ip)))++ = ((((0)&0x03)<<6)|(((((a1)))&0x07)<<3)|(((5)&0x07))); } while (0); do { x86_imm_buf imb; imb.val = (int) (((&op->flt_imm))); *(((jit->ip)))++ = imb.b [0]; *(((jit->ip)))++ = imb.b [1]; *(((jit->ip)))++ = imb.b [2]; *(((jit->ip)))++ = imb.b [3]; } while (0); } while (0); } while (0); break;
