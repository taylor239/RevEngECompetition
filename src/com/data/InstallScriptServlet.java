...
public class InstallScriptServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String mariaPassword = "uBgiDDGhndviQeEZ";
		...
		+ "\npkill -f \"/usr/bin/java -jar --add-modules java.xml.bind -XX:+IgnoreUnrecognizedVMOptions /opt/dataCollector/DataCollector.jar\"" 
		+ "\n/usr/bin/java -Xmx1536m -jar --add-modules java.xml.bind -XX:+IgnoreUnrecognizedVMOptions /opt/dataCollector/DataCollector.jar -user " + curEmail + " -server " + serverName + ":" + port + " -databasePassword " + mariaPassword + " -event RevEngECompetition >> /opt/dataCollector/log.log 2>&1" 
